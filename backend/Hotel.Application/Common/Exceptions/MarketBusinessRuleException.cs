...
/// </summary>
public sealed class HotelBusinessRuleException : Exception
{
    public string Code { get; }

    public HotelBusinessRuleException(string code, string message)
        : base(message)
    {
        Code = code;
    }

    public HotelBusinessRuleException(string code, string message, Exception? innerException)
