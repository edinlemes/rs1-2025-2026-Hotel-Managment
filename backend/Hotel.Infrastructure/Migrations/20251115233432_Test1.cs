        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DiscountType = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyMailAddress = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RateTypeName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StaffRooms_Staff_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffShiftAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StaffShiftAssignments_StaffShift_ShiftId",
                        column: x => x.ShiftId,
                        principalTable: "StaffShift",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StaffShiftAssignments_Staff_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staff",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestServices_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuestServices_HotelServices_HotelServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestServices_BookingId",
                table: "GuestServices",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestServices_HotelServiceId",
                table: "GuestServices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffShiftAssignments_ShiftId",
                table: "StaffShiftAssignments",
                column: "ShiftId");

            migrationBuilder.CreateIndex(
                name: "IX_StaffShiftAssignments_StaffId",
                table: "StaffShiftAssignments",
                column: "StaffId");
